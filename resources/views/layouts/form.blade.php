...
<head>
  ...
  @yield('CSS')    {{-- solo añadimos yield en ambas partes para css y js --}}
...
<body class="bg-gradient-info">
  <div class="main-content border-default ">
    <!-- Navbar -->
    <nav class="navbar navbar-top navbar-horizontal navbar-expand-md navbar-dark">
      <div class="container px-4">
        <a class="navbar-brand" href="#">
          <img src="{{asset('img/naabol/white.png')}}" style="width: 350px; height:200px ">
        </a>
    ...
    <!-- Header -->
    <div class="container py-6 py-lg-7"> {{-- aqui va el color del fondo  --}}
      <div class="container">
