                ...
                <div class="card card-info">
                  <div class="card-header">
                    ...
                    <div class="card-tools">
                      ...
                      <form action="{{ url('/metslcb') }}" method="get">
                        <div class="card-body">
                          <div class="row">
                  ...
                  $(document).ready(function() {
                      $('#tablaespecial').DataTable( {
                          ...
                          buttons: [
                            ...
                            { extend: 'copy',  className:'copyButton',                    filename: 'Base de datos SLCB' },
                            { extend: 'excelHtml5', className: 'btn btn-outline-success', filename: 'Base de datos SLCB' },
                            { extend: 'csv', className: 'csvButton',                      filename: 'Base de datos SLCB' },
                            { extend: 'pdf', className: 'dpfButton',                      filename: 'Base de datos SLCB' },
                            { extend: 'print', className: 'printButton',                  filename: 'Base de datos SLCB' }
                          ],
