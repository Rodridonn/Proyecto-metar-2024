          ...
          <div class="row align-items-center">
            ...
            <div class="row d-flex justify-content-between">
              ...
              <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="card-body">
                  <a href="{{ url('/metslra/create' )}}" class="btn btn-sm btn-primary btn-block flex-fill">Añadir nuevo registro</a>
                </div>
              </div>
            </div>
                ...
                <div class="card card-info">
                  <div class="card-header">
                    ...
                    <div class="card-tools">
                      ...
                      <form action="{{ url('/metslra') }}" method="get">
                        <div class="card-body">
                          <div class="row">
          ...
          <table id="tablaespecial" class="table align-items-center table-flush">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <form action="{{url('/metslra/'.$met->id)}}" method="POST">  {{-- botones de editar y eliminar --}} 
                    @csrf
                    @method('DELETE')
                    <a href="{{url('/metslra/'.$met->id. '/edit')}}" class="btn btn-sm btn-primary">Editar</a>
                  ...
                  $(document).ready(function() {
                      $('#tablaespecial').DataTable( {
                          ...
                          buttons: [
                            ...
                            { extend: 'copy',  className:'copyButton',                    filename: 'Base de datos SLRA' },
                            { extend: 'excelHtml5', className: 'btn btn-outline-success', filename: 'Base de datos SLRA' },
                            { extend: 'csv', className: 'csvButton',                      filename: 'Base de datos SLRA' },
                            { extend: 'pdf', className: 'dpfButton',                      filename: 'Base de datos SLRA' },
                            { extend: 'print', className: 'printButton',                  filename: 'Base de datos SLRA' }
                          ],
