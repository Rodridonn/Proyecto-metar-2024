                ...
                <div class="card card-info">
                  <div class="card-header">
                    ...
                    <div class="card-tools">
                      ...
                      <form action="{{ url('/metsltr') }}" method="get">
                        <div class="card-body">
                          <div class="row">
              ...
              <tr>
                ...
                <td>
                    @if(auth()->user() && auth()->user()->id === 23)
                        <form action="{{ url('/metsltr/'.$met->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <a href="{{ url('/metsltr/'.$met->id.'/edit') }}" class="btn btn-sm btn-primary">Editar</a>
                  ...
                  $(document).ready(function() {
                      $('#tablaespecial').DataTable( {
                          ...
                          buttons: [
                            ...
                            { extend: 'copy',  className:'copyButton',                    filename: 'Base de datos SLTR' },
                            { extend: 'excelHtml5', className: 'btn btn-outline-success', filename: 'Base de datos SLTR' },
                            { extend: 'csv', className: 'csvButton',                      filename: 'Base de datos SLTR' },
                            { extend: 'pdf', className: 'dpfButton',                      filename: 'Base de datos SLTR' },
                            { extend: 'print', className: 'printButton',                  filename: 'Base de datos SLTR' }
                          ],
